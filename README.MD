...
[![Go Report Card](https://goreportcard.com/badge/github.com/epavanello/gorsk)](https://goreportcard.com/report/github.com/epavanello/gorsk)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/epavanello/gorsk-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/epavanello/gorsk` to `$GOPATH/github.com/author/project`. We use [task](https://github.com/go-task/task) as a task runner. Run ``task relocate`` to rename the packages, e.g. ``task relocate TARGET=github.com/author/project``
...
`swagger.bat generate spec -o ./assets/swaggerui/swagger.json --scan-models`